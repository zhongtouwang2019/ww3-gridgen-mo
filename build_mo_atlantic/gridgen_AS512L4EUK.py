...
bathyfile = '/project/ofrd/bathymetry/gebco_reduced_euro_2.nc'
...
if gentier:
    ...
    basesmcrm = grd.loadNCsmc(writedir+'/atlantic_AS512L3EUK.nc')
    # visualise the grid
...
if combtier:
    ...
    tier1smc = grd.loadNCsmc(writedir+'/atlantic_AS512L4EUK-sub.nc')
    # visualise the grid
    ...
    combbaset1.label = 'AS512L4EUK-comb'
...
if writeww3:
    ...
    combsmc = grd.loadNCsmc(writedir+'/atlantic_AS512L4EUK-comb.nc')
    # visualize the grid
    ...
    combsmc.writeWW3(writedir='/project/ofrd/waves/wavegrids/atlantic/AS512L4EUK')
    print('*** Writing boundary cells to text file')
    combsmc.writeBounds(writedir='/project/ofrd/waves/wavegrids/atlantic/AS512L4EUK',
                         lon360=False, south=True)
