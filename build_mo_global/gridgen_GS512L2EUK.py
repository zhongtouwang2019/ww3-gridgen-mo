...
if combtier:
    ...
    tier1smc = grd.loadNCsmc(writedir+'/global_GS512L2EUK-sub.nc')
    # visualise the grid
    ...
    combbaset1.label = 'GS512L2EUK-comb'
...
if gridmk6:
    ...
    basesmcrm = grd.loadNCsmc(writedir+'/global_GS512L2EUK-comb.nc')
    # visualise the grid
    grd.plotGridsmc(basesmcrm)

    print('')
    print('*** Adding tier cells in specified regions')
    basesmcrm.label = 'GS512L2EUK'
    basesmcrm.markRegion(342.0, 30.0, 360.0, 63.0, marker='tier', depthlim=320.0) # Euro region west of Greenwich
    basesmcrm.markRegion(0.0, 30.0, 42.0, 63.0, marker='tier', depthlim=320.0) # Euro region east of Greenwich
