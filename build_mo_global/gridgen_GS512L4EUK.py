...
if gentier:
    ...
    basesmcrm = grd.loadNCsmc(writedir+'/global_GS512L3EUK.nc')
    # visualise the grid
...
if combtier:
    ...
    tier1smc = grd.loadNCsmc(writedir+'/global_GS512L4EUK-sub.nc')
    # visualise the grid
    ...
    combbaset1.label = 'GS512L4EUK-comb'
...
if writeww3:
    ...
    combsmc = grd.loadNCsmc(writedir+'/global_GS512L4EUK-comb.nc')
    # visualize the grid
    ...
    combsmc.writeWW3(writedir='/project/ofrd/waves/wavegrids/global/GS512L4EUK')
